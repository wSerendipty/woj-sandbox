package com.wcy.wojcodesandbox.templateCode;
...
public class Test {
    ...
    static {
        ...
        map.put("[[S", "short[][]");
        map.put("[[B", "byte[][]");
        map.put("com.wcy.wojcodesandbox.templateCode.TreeNode", "TreeNode");
    }
                    ...
                    if ( paramType != null) {
                        switch (paramType){
                            ...
                            case "long[][]":
                                ...
                                break;
                            case "TreeNode":
                                System.out.println("TreeNode " + "treeNode" + i + " = " + "new TreeNode();");
                                break;
                            default:
                                break;
                        }
                        System.out.println(map.get(parameterType.getName()));
                    }
                }
                // 调用 solution
                try {
                    method.invoke(solution, arrayList.toArray());
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
